...
conjugated coordinates. Reciprocity is equivalent to the existence of an
exchange-Hermitian mirror partner of the kernel; unidirectionality removes this
partner. All symbolic claims are certified by exact Wirtinger-derivative
...
single-versus-twin-comb reciprocity test. Numerical simulations with
...
conjugation-exchange symmetry that reality locking enforces. The body of the
...
product of conjugated coordinates; (ii) a dichotomy --- reciprocity is equivalent
to the presence of an exchange-Hermitian mirror partner of the kernel, and
one-way coupling deletes that partner; (iii) a three-fold classification of the
...
counterexamples on the reciprocal side. At the level of machine-verified simulation and one elementary hand proof, we further establish: (iv) the kernel's intrinsic, emergent analyticity boundary and the chiral phase law of its cut, with class-level genericity; (v) a Fourier floor theorem for the interference relief of large kernel sums, with sampling-dependent convergence rates and a discreteness dichotomy for the log-scale calendar; (vi) closed-form floors for the canonical ladder families; (vii) a one-way spectroscopy with proven limits. We further propose a fiber-loop
...
\subsection{Reciprocity as an exchange symmetry; the mirror-partner statement}
\label{sec:mirror}
...
Three independent formula-level properties position the one-way kernel. First,
...
accompanies it, in contrast with every reciprocal control. Third,
...
its branch-safe form --- are certified by exact symbolic computation of
...
Section~\ref{sec:structure}. It would not establish anything beyond that. In
